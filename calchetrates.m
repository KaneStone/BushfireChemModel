function [kout] = calchetrates(variables,Tin,Pin,CLONO2atm,HCLatm,SAD,wt,M_hcl_h2so4,molar_h2so4,aw,timeind)
%w1 = wt;
%wt = wt2;
...
%     rxt.clono2_hcl = wrk.*av_clono2.*gprob_cnt_hcl.*(1./variables.HCl(timeind));
% else     
%     rxt.clono2_hcl = wrk.*av_clono2.*gprob_cnt_hcl.*(1./variables.ClONO2(timeind));
% end
%      
% %% HOCL + HCl
