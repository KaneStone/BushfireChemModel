...
kv.N2_O1D = k.N2_O1D.*variables.O1D.*atmosphere.atLevel.N2.nd(step.doy);
kv.O2_O1D = k.O2_O1D.*variables.O1D.*atmosphere.atLevel.O2.nd(step.doy);
kv.OH_OH = k.OH_OH.*variables.OH.^2;
kv.O_O2_M = k.O_O2_M.*variables.O.*atmosphere.atLevel.O2.nd(step.doy);
...
kv.O1D_N2Oa = k.O1D_N2Oa.*variables.O1D.*atmosphere.atLevel.N2O.nd(step.doy);
kv.O1D_N2Ob = k.O1D_N2Ob.*variables.O1D.*atmosphere.atLevel.N2O.nd(step.doy);
kv.HCL_O1D = k.HCL_O1D.*variables.O1D.*variables.HCL;
kv.O1D_O3 = k.O1D_O3.*variables.O1D.*variables.O3;

kv.H_O3 = k.H_O3.*variables.O3.*atmosphere.atLevel.H.nd(step.doy);
...
kv.CL_H2 = k.CL_H2.*variables.CL.*atmosphere.atLevel.H2.nd(step.doy);
...
kv.CL_CH2O = k.CL_CH2O.*variables.CL.*atmosphere.atLevel.CH2O.nd(step.doy);
kv.CL_CH4 = k.CL_CH4.*variables.CL.*atmosphere.atLevel.CH4.nd(step.doy);
...
kv.CLO_CH3O2 = k.CLO_CH3O2.*variables.CLO.*atmosphere.atLevel.CH3O2.nd(step.doy);
...
kv.CH3O2_NO = k.CH3O2_NO.*variables.NO.*atmosphere.atLevel.CH3O2.nd(step.doy);
...
kv.NO3_CH2O = k.NO3_CH2O.*variables.NO3.*atmosphere.atLevel.CH2O.nd(step.doy);

kv.OH_HO2 = k.OH_HO2.*variables.OH.*variables.HO2;
kv.OH_H2 = k.OH_H2.*variables.OH.*atmosphere.atLevel.H2.nd(step.doy);
kv.OH_H2O2 = k.OH_H2O2.*variables.OH.*variables.H2O2;
kv.OH_OH_M = k.OH_OH_M.*variables.OH.^2;
kv.CH4_OH = k.CH4_OH.*variables.OH.*atmosphere.atLevel.CH4.nd(step.doy);

kv.OH_CH2O = k.OH_CH2O.*variables.OH.*atmosphere.atLevel.CH2O.nd(step.doy);
kv.OH_CO_Ma = k.OH_CO_Ma.*variables.OH.*atmosphere.atLevel.CO.nd(step.doy);
kv.OH_CO_Mb = k.OH_CO_Mb.*variables.OH.*atmosphere.atLevel.CO.nd(step.doy);

kv.H2_O1D = k.H2_O1D.*variables.O1D.*atmosphere.atLevel.H2.nd(step.doy);
kv.CH4_O1D = k.CH4_O1D.*variables.O1D.*atmosphere.atLevel.CH4.nd(step.doy);
kv.H2O2_O = k.H2O2_O.*variables.H2O2.*variables.O;
kv.HO2_HO2 = k.HO2_HO2.*variables.HO2.^2;
kv.HO2_CH2O = k.HO2_CH2O.*variables.HO2.*atmosphere.atLevel.CH2O.nd(step.doy);

kv.H_O2_M = k.H_O2_M.*atmosphere.atLevel.H.nd(step.doy).*atmosphere.atLevel.O2.nd(step.doy); %no way this is important in lower stratopshere
...
rates.NO.production(end+1) = kv.O1D_N2Oa.*2;
