...
%     
    ...
    if i == daycount*24/inputs.hourstep
        ...
        dayaverage.CL2(daycount+1) = dayaverage.CL(daycount+1);
...
dayaverage.O3 = mean(reshape(variables.O3(1,1:inputs.timesteps),[tstepsinday,inputs.days]),1,'omitnan');
dayaverage.CLO = mean(reshape(variables.CLO(1,1:inputs.timesteps),[tstepsinday,inputs.days]),1,'omitnan');
dayaverage.CLONO2 = mean(reshape(variables.CLONO2(1,1:inputs.timesteps),[tstepsinday,inputs.days]),1,'omitnan');
dayaverage.HCL = mean(reshape(variables.HCL(1,1:inputs.timesteps),[tstepsinday,inputs.days]),1,'omitnan');
