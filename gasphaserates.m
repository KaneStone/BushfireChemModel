...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    rate.NO_O_M = termolecular(k0,ki)...
     ...
     % NO2 + NO3 + M ->  N2O5 + M 
%     k00 = 2.00e-30*(300./atmosphere.atLevel.T(step.doy).^4.40;             
%     kii = 1.40e-12*(300./atmosphere.atLevel.T(step.doy).^0.70;   
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    
    ...
    % OH + H2O2 ->  H2O + HO2  
    rate.OH_H2O2 = 1.80e-12.*variables.OH(timeind).*variables.H2O2(timeind);   
    
    % OH + CH2O ->  CO + H2O + H 
    rate.OH_CH2O = 5.5e-12*exp(125./atmosphere.atLevel.T(step.doy))...
        .*variables.OH(timeind).*atmosphere.atLevel.CH2O.nd(step.doy);   
    
    % HO2 + CH2O ->  HOCH2OO
    rate.HO2_CH2O = 9.7e-15*exp(625./atmosphere.atLevel.T(step.doy))...
        .*variables.HO2(timeind).*atmosphere.atLevel.CH2O.nd(step.doy);   
    ...
    rate.CH4_O1D = 1.31e-10...
        .*atmosphere.atLevel.CH4.nd(step.doy).*variables.O1D(timeind);                                 
    ...
    rate.OH_CO_M = 1.5e-13.*(1+6e-8.*1e7.*1.38e-23.*atmosphere.atLevel.M(step.doy)).*...
        atmosphere.atLevel.T(step.doy).*variables.OH(timeind).*atmosphere.atLevel.CO.nd(step.doy);
    
% HOx unused
    % H2O2 + O ->  OH + HO2
    rate.H2O2_O = 1.40e-12*exp(-2000./atmosphere.atLevel.T(step.doy))...
        .*variables.H2O2(timeind).*variables.O(timeind);                        
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
    ...
    rate.CL_H2O2 = 1.10e-11*exp(-980./atmosphere.atLevel.T(step.doy))...
        .*variables.CL(timeind).*variables.H2O2(timeind);  
...
%         .*atmosphere.atLevel.C2H6.nd(step.doy).*variables.CL(timeind);   
    ...
    rate.HBR_O1D = 1.2e-10...
            .*variables.HBR(timeind).*variables.O1D(timeind);                                
