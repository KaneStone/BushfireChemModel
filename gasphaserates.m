function rates = gasphaserates(inputs,step,variables,dayaverage,atmosphere,i,rates,photo,climScaleFactor,SZAdiff)
...
%          atmosphere.atLevel.O2.nd(step.doy).*variables.O(i).*atmosphere.atLevel.M(step.doy).*day; %O2_O_M 
%      rates.O.destruction(2) = 8.00e-12.*exp(-2060./atmosphere.atLevel.T(step.doy)).*variables.O(i).*variables.O3(i).*day;
%      rates.O.destruction(3) = 1.8e-11.*exp(180./atmosphere.atLevel.T(step.doy)).*variables.O(i).*atmosphere.atLevel.OH.nd(step.doy).*day;
%      rates.O.destruction(4) = 3.00e-12.*exp(200./atmosphere.atLevel.T(step.doy)).*variables.O(i).*atmosphere.atLevel.HO2.nd(step.doy).*day;
...
O1D = photo(2).*variables.O3(i)./(kO1D_N2.*atmosphere.atLevel.N2.nd(step.doy) + kO1D_O2.*atmosphere.atLevel.O2.nd(step.doy));
%O1D = O1D*5000;
...
%     else
        rates.O3.destruction(2) = 8e-12.*exp(-2060./atmosphere.atLevel.T(step.doy)).*variables.O3(i).*atmosphere.atLevel.O.nd(step.doy).*day; %O_O3 
%     end
    %rates.O3.destruction(3) = 1e-10.*variables.O3(i).*atmosphere.atLevel.O1D.nd(step.doy);%O1D_O3 
    rates.O3.destruction(3) = 1e-10.*variables.O3(i).*O1D;%O1D_O3 
    rates.O3.destruction(10) = 1.40e-10.*exp(-470./atmosphere.atLevel.T(step.doy)).*variables.O3(i).*atmosphere.atLevel.H.nd(step.doy).*day;  %dH_O3 
    rates.O3.destruction(4) = 1.70e-12.*exp(-940./atmosphere.atLevel.T(step.doy)).*variables.O3(i).*atmosphere.atLevel.OH.nd(step.doy).*day; %OH_O3 
    rates.O3.destruction(5) = 1.0e-14.*exp(-490./atmosphere.atLevel.T(step.doy)).*variables.O3(i).*atmosphere.atLevel.HO2.nd(step.doy).*day; %HO2_O3 
    rates.O3.destruction(6) = 3e-12.*exp(-1500./atmosphere.atLevel.T(step.doy)).*variables.O3(i).*atmosphere.atLevel.NO.nd(step.doy).*day; %NO_O3 
    ...
    rates.O3.destruction(8) = 2.30e-11.*exp(-200./atmosphere.atLevel.T(step.doy)).*variables.O3(i).*atmosphere.atLevel.CL.nd(step.doy).*day; %CL_O3
    %rates.O3.destruction(8) = 2.30e-11.*exp(-200./atmosphere.atLevel.T(step.doy)).*variables.O3(i).*dayaverage.CL(step.doy).*day; %CL_O3
...
rates.CLONO2.production(1) = k2clono2.*variables.CLO(i).*atmosphere.atLevel.NO2.nd(step.doy);

% gas phase
CLONO2_dlength = length(rates.CLONO2.destruction);
rates.CLONO2.destruction(CLONO2_dlength+1) = 3.6e-12.*exp(-840./atmosphere.atLevel.T(step.doy)).*variables.CLONO2(i).*atmosphere.atLevel.O.nd(step.doy).*day;
rates.CLONO2.destruction(CLONO2_dlength+2) = 1.2e-12.*exp(-330./atmosphere.atLevel.T(step.doy)).*variables.CLONO2(i).*atmosphere.atLevel.OH.nd(step.doy).*day;
%rates.CLONO2.destruction(CLONO2_dlength+3) = 6.5e-12.*exp(-135./atmosphere.atLevel.T(step.doy)).*variables.CLONO2(i).*dayaverage.CL(step.doy).*day;
rates.CLONO2.destruction(CLONO2_dlength+3) = 6.5e-12.*exp(-135./atmosphere.atLevel.T(step.doy)).*variables.CLONO2(i).*atmosphere.atLevel.CL.nd(step.doy).*day;
...
rates.HCL.production(6) = 3.40e-12*exp(-130./atmosphere.atLevel.T(step.doy)).*variables.HOCL(i).*atmosphere.atLevel.CL.nd(step.doy).*day;
rates.HCL.production(6) = 3.40e-12*exp(-130./atmosphere.atLevel.T(step.doy)).*variables.HOCL(i).*atmosphere.atLevel.CL.nd(step.doy).*day;
...
rates.HCL.destruction(HCL_dlength+1) = 1.5e-10.*O1D.*variables.HCL(i);
rates.HCL.destruction(HCL_dlength+2) = 1.8e-12.*exp(-250./atmosphere.atLevel.T(step.doy)).*atmosphere.atLevel.OH.nd(step.doy).*variables.HCL(i).*day;
rates.HCL.destruction(HCL_dlength+3) = 1.0e-11.*exp(-3300./atmosphere.atLevel.T(step.doy)).*atmosphere.atLevel.O.nd(step.doy).*variables.HCL(i).*day;
...
rates.CLO.destruction(CLO_dlength+1) = k2clo.*variables.CLO(i).*variables.CLO(i);
...
rates.CLO.production(CLO_plength+1) = 2.3e-11.*exp(-200./atmosphere.atLevel.T(step.doy)).*variables.O3(i).*atmosphere.atLevel.CL.nd(step.doy).*day;
%rates.CLO.production(CLO_plength+1) = 2.3e-11.*exp(-200./atmosphere.atLevel.T(step.doy)).*variables.O3(i).*dayaverage.CL(step.doy).*day;
...
rates.CLO.production(CLO_plength+3) = 1.70e-13.*variables.HOCL(i).*atmosphere.atLevel.O.nd(step.doy).*day;
%rates.CLO.production(CLO_plength+4) = 3.40e-12.*exp(-130./atmosphere.atLevel.T(step.doy)).*variables.HOCL(i).*atmosphere.atLevel.CL.nd(step.doy).*day;
rates.CLO.production(CLO_plength+4) = 3.40e-12.*exp(-130./atmosphere.atLevel.T(step.doy)).*variables.HOCL(i).*atmosphere.atLevel.CL.nd(step.doy).*day;
rates.CLO.production(CLO_plength+5) = 3.00e-12.*exp(-500./atmosphere.atLevel.T(step.doy)).*variables.HOCL(i).*atmosphere.atLevel.OH.nd(step.doy).*day;
rates.CLO.production(CLO_plength+6) = 3.60e-12.*exp(-840./atmosphere.atLevel.T(step.doy)).*variables.CLONO2(i).*atmosphere.atLevel.O.nd(step.doy).*day;
...
rates.CLO.destruction(CLO_dlength+2) = 2.80e-11*exp(85./atmosphere.atLevel.T(step.doy)).*variables.CLO(i).*atmosphere.atLevel.O.nd(step.doy).*day;
rates.CLO.destruction(CLO_dlength+3) = 7.40e-12*exp(260./atmosphere.atLevel.T(step.doy)).*variables.CLO(i).*atmosphere.atLevel.OH.nd(step.doy).*day;
rates.CLO.destruction(CLO_dlength+4) = 6.00e-13*exp(230./atmosphere.atLevel.T(step.doy)).*variables.CLO(i).*atmosphere.atLevel.OH.nd(step.doy).*day;
rates.CLO.destruction(CLO_dlength+5) = 2.60e-12*exp(290./atmosphere.atLevel.T(step.doy)).*variables.CLO(i).*atmosphere.atLevel.HO2.nd(step.doy).*day;
rates.CLO.destruction(CLO_dlength+6) = 6.40e-12*exp(290./atmosphere.atLevel.T(step.doy)).*variables.CLO(i).*atmosphere.atLevel.NO.nd(step.doy).*day;
%rates.CLO.destruction(CLO_dlength+7) = rates.CLONO2.production(1);
rates.CLO.destruction(CLO_dlength+7) = k2clono2.*variables.CLO(i).*atmosphere.atLevel.NO2.nd(step.doy);
rates.CLO.destruction(CLO_dlength+8) = 3.0e-11*exp(-2450./atmosphere.atLevel.T(step.doy)).*variables.CLO(i).*variables.CLO(i);
rates.CLO.destruction(CLO_dlength+9) = 1.0e-12*exp(-1590./atmosphere.atLevel.T(step.doy)).*variables.CLO(i).*variables.CLO(i);
rates.CLO.destruction(CLO_dlength+10) = 3.5e-13*exp(-1370./atmosphere.atLevel.T(step.doy)).*variables.CLO(i).*variables.CLO(i);

% lifetime of ClO

lifetime = 1./((rates.CLO.destruction(CLO_dlength+7) + rates.CLO.destruction(CLO_dlength+6))./variables.CLO(i));
...
rates.CL2.production(CL2_plength+1) = 1.00e-12.*exp(-1590./atmosphere.atLevel.T(step.doy)).*2.*variables.CLO(i);
rates.CL2.production(CL2_plength+1) = 6.50e-12.*exp(135./atmosphere.atLevel.T(step.doy)).*variables.CLONO2(i).*atmosphere.atLevel.CL.nd(step.doy).*day;
%rates.CL2.production(CL2_plength+1) = 6.50e-12.*exp(135./atmosphere.atLevel.T(step.doy)).*variables.CLONO2(i).*dayaverage.CL(step.doy).*day;
...
% if i == 1
%     a = 1;
% %     lifetime = 1./(sum(rates.CL.destruction)./variables.CL(i));
% end
% 
% d2 = 2.30e-11.*exp(-200./atmosphere.atLevel.T(step.doy)).*variables.O3(i);
...
% 
% CLtest = d2./(d3+d4+(rates.CLO.destruction(1)+rates.CLO.destruction(2))./variables.CLO(i));
% if isnan(CLtest) || CLtest == 0
%     rates.CL.production(1) = 0;
% else
%     rates.CL.production(1) = variables.CLO(i)./CLtest;
%     if SZAdiffout <= 0 && rates.CL.production(1) < variables.CL(i)
%         rates.CL.production(1) = variables.CL(i).*daynorm;    
% %     elseif SZAdiffout >= 0 && rates.CL.production(1) > variables.CL(i)
% %         rates.CL.production(1) = variables.CL(i).*daynorm;  
% %     end
%     end
% end
...
% %     lifetime = 1./(sum(rates.CL.destruction)./variables.CL(i));
% % end
% %rates.CL.production(CL_plength+1) = 1.00e-12.*exp(-1590./atmosphere.atLevel.T(step.doy)).*2.*variables.CLO(i);
% rates.CL.production(CL_plength+1) = 1.50e-10.*O1D.*variables.HCL(i);
% rates.CL.production(CL_plength+2) = 2.80e-11.*exp(85./atmosphere.atLevel.T(step.doy)).*variables.CLO(i).*atmosphere.atLevel.O.nd(step.doy).*day;
% rates.CL.production(CL_plength+3) = 7.40e-12.*exp(270./atmosphere.atLevel.T(step.doy)).*variables.CLO(i).*atmosphere.atLevel.OH.nd(step.doy).*day;
% rates.CL.production(CL_plength+4) = 3.30e-12.*exp(-115./atmosphere.atLevel.T(step.doy)).*variables.CLO(i).*atmosphere.atLevel.CH3O2.nd(step.doy);
% rates.CL.production(CL_plength+5) = 6.40e-12.*exp(290./atmosphere.atLevel.T(step.doy)).*variables.CLO(i).*atmosphere.atLevel.NO.nd(step.doy).*day;
% rates.CL.production(CL_plength+6) = 3.00e-11.*exp(-2450./atmosphere.atLevel.T(step.doy)).*2.*variables.CLO(i).*variables.CLO(i);
% rates.CL.production(CL_plength+7) = 3.50e-13.*exp(-1370./atmosphere.atLevel.T(step.doy)).*variables.CLO(i).*variables.CLO(i);
% rates.CL.production(CL_plength+8) = 1.80e-12.*exp(-250./atmosphere.atLevel.T(step.doy)).*variables.HCL(i).*atmosphere.atLevel.OH.nd(step.doy).*day;
% rates.CL.production(CL_plength+9) = 1.00e-11.*exp(-3300./atmosphere.atLevel.T(step.doy)).*variables.HCL(i).*atmosphere.atLevel.O.nd(step.doy).*day;
% rates.CL.production(CL_plength+10) = 2.30e-12.*exp(260./atmosphere.atLevel.T(step.doy)).*variables.CLO(i).*atmosphere.atLevel.BRO.nd(step.doy).*day;
...
% rates.CL.production(CL_plength+13) = 2.80e-11.*variables.CLO(i).*atmosphere.atLevel.SO.nd(step.doy);
% 
% rates.CL.destruction(CL_dlength+1) = 2.30e-11.*exp(-200./atmosphere.atLevel.T(step.doy)).*variables.O3(i).*variables.CL(i);
% rates.CL.destruction(CL_dlength+2) = 3.05e-11.*exp(-2270./atmosphere.atLevel.T(step.doy)).*variables.CL(i).*atmosphere.atLevel.H2.nd(step.doy);
% rates.CL.destruction(CL_dlength+3) = 1.10e-11.*exp(-980./atmosphere.atLevel.T(step.doy)).*variables.CL(i).*atmosphere.atLevel.H2O2.nd(step.doy);
% rates.CL.destruction(CL_dlength+4) = 1.40e-11.*exp(270./atmosphere.atLevel.T(step.doy)).*variables.CL(i).*atmosphere.atLevel.HO2.nd(step.doy).*day;
% rates.CL.destruction(CL_dlength+5) = 3.60e-11.*exp(-375./atmosphere.atLevel.T(step.doy)).*variables.CL(i).*atmosphere.atLevel.HO2.nd(step.doy).*day;
% rates.CL.destruction(CL_dlength+6) = 7.30e-12.*exp(-1280./atmosphere.atLevel.T(step.doy)).*variables.CL(i).*atmosphere.atLevel.CH4.nd(step.doy);
% rates.CL.destruction(CL_dlength+7) = 3.40e-12.*exp(-130./atmosphere.atLevel.T(step.doy)).*variables.CL(i).*variables.HOCL(i);
% rates.CL.destruction(CL_dlength+8) = 6.50e-12.*exp(135./atmosphere.atLevel.T(step.doy)).*variables.CL(i).*variables.CLONO2(i);
% rates.CL.destruction(CL_dlength+9) = 2.17e-11.*exp(-1130./atmosphere.atLevel.T(step.doy)).*variables.CL(i).*atmosphere.atLevel.CH3CL.nd(step.doy);
% 
% 
% if i == 4000
%     lifetime = 1./(sum(rates.CL.destruction)./variables.CL(i));
...
%rates.CL.destruction(CL_dlength+10) = 8.10e-11.*exp(-30./atmosphere.atLevel.T(step.doy)).*variables.CL(i).*atmosphere.atLevel.CH2O.nd(step.doy);
% rates.CL.destruction(CL_dlength+11) = 1.4e-11.*exp(-1030./atmosphere.atLevel.T(step.doy)).*variables.CL(i).*atmosphere.atLevel.CH3BR.nd(step.doy);
% rates.CL.destruction(CL_dlength+12) = 1.4e-11.*exp(-1030./atmosphere.atLevel.T(step.doy)).*variables.CL(i).*atmosphere.atLevel.CH3BR.nd(step.doy);
%% CL2O2 r91*M*CLO*CLO
...
if i == 500
    %HOCLlifetime = 1./(sum(rates.HOCL.destruction)./variables.HOCL(i))
end
...
if day ~= 0
    rates.CLOtest.production = variables.HOCL(i)./(d33./(rates.HOCL.destruction(1)./variables.HOCL(i)+d34));
else
